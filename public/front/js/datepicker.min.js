...
gj.widget = function () {
    ...
    config: {
        base: {
            ...
            keepExpandedRows: !0,
            expandedRows: [],
            icons: {expandRow: '<i class="fas fa-chevron-right" />', collapseRow: '<i class="gj-icon chevron-down" />'}
        },
        fontawesome: {
            icons: {
    ...
    base: {
        ...
        icons: {expand: '<i class="fas fa-chevron-right" />', collapse: '<i class="gj-icon chevron-down" />'}
    },
    bootstrap: {
        style: {
