                                    ...
                                    @foreach($hotel->rooms as $room)
                                        ...
                                        <div class="list-box mb-30">
                                            <div class="list-box-img">
                                                @foreach($room->room_images as $roomImages) <a href="front/img/rooms-image/{{ $roomImages->path }}" class="venobox" data-gall="gallery1"> @endforeach <img src="front/img/rooms/{{ $roomImages->path }}" alt=""> </a>

                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="exampleCheck1">
                                                    <label class="form-check-label" for="exampleCheck1">Select
                                                        Room</label>
                                                </div>
                                            </div>
