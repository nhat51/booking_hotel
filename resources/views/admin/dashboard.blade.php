            ...
            <div class="row justify-content-center">
                <div class="col-md-3 pt-5 pb-5">
                    <div class="list-group">
                        @can('manage-users')
                            <a href="{{route('admin.users.index')}}" class="list-group-item list-group-item-action list-group-item-dark active">
                ...
                <div class="col-md-9 pt-5 pb-5">
                    ...
                    <div class="card w-auto">
                        <div class="card-header text-white bg-dark">List users</div>
                        <div class="card-body">
